...
%description ceph
This plugin monitor CEPH daemon
...
This plugin monitor LogStash daemon
...
This plugin for collectd provides OpenLDAP monitoring.
...
%description smart
This plugin for collectd provides ATASmart support.
...
ln -fs %{_sysconfdir}/collection.conf %{buildroot}%{_datadir}/collectd/collection3/etc/collection.conf
